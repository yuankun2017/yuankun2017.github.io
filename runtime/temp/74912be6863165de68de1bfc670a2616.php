<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view2/wechat/add_text.html";i:1503541897;s:44:"./application/admin/view2/public/layout.html";i:1503541889;}*/ ?>
<!doctype html>
<html>
<head>
  ...
  <form class="form-horizontal" method="post" id="handlepost" action="">    
    <div class="ncap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" name="keyword" id="keyword" value="<?php echo $keyword['keyword']; ?>" class="input-txt">
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
          <label for="cate_id"><em>*</em>回复内容</label>
        </dt>
        <dd class="opt">
         <textarea name="text" rows="6"  placeholder="回复内容" class="tarea" id="subject_desc"><?php echo $keyword['text']; ?></textarea>
        </dd>
      </dl>    
