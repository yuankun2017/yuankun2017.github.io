<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"./application/admin/view2/plugin/setting.html";i:1503541887;s:44:"./application/admin/view2/public/layout.html";i:1503541889;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <?php endif; ?>
                    <p class="notic"><?php echo $config['label']; ?></p>
                </dd>
            </dl>
            <?php endforeach; endif; else: echo "" ;endif; ?>
